...
/*
#cgo LDFLAGS: -L../native -lstress_gpu
#include "../native/stress_gpu.h"
*/
import "C"
import (
	"bufio"
	"fmt"
	enum "go-nvidia-gpu-stress/internal"
	"os"
	"time"
)

func main() {
	N := enum.VRAM_8GB // Matrix dimension for the stress kernel (8GB).
